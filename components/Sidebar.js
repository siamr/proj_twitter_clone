...
function Sidebar() {
    ...
    return (
        <div className='hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
            ...
            {/* <button className='hidden xl:inline ml-auto bg-[#1d9bf0] text-white rounded-full w-56 h-[52px] text-lg font-bold shadow-md
            ...
            <div onClick={signOut} className="text-[#d9d9d9] flex items-center justify-center hoverAnimation xl:ml-auto xl:-mr-5 mt-auto" >
                ...
                <div className="hidden xl:inline leading-5">
                    ...
                    <p className='text-[#6e767d] text-[14px]'>Click here to sign out</p>
                </div>
